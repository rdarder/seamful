...
class Container:
    ...
    def _provide(self, resource: ResourceType[T]) -> T:
        ...
        return provider_method.method(
            None, **method_parameters
    ...
    def _register_public_module(self, module):
    ...
    def _register_private_module(self, module: ModuleType):
