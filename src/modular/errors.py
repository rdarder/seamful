...
def rname(resource: "BoundResource[Any]") -> str:
    from modular.resource import ModuleResource, ProviderResource
...
def rdef(resource: "BoundResource[Any]") -> str:
    from modular.resource import ModuleResource, OverridingResource, PrivateResource
...
elif os.environ.get("MODULAR_DISABLE_ERROR_DEFINITION_LINE") == "1":
    INCLUDE_DEFINITION_LINE = False
else:
